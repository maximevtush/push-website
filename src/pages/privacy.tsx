          ...
          <Content className='contentBox'>
            ...
            >
              ...
              >
                ...
                <P margin='20px 0px 0px 20px'>
                  <B>(c)</B> images and voice recordings of our conversations
                  with you, whether from our events or office surveillances or
                  otherwise;
                </P>
                ...
                <P margin='20px 0px 0px 20px'>
                  <B>(i)</B> banking information (e.g. account numbers and
                ...
                <P margin='20px 0px 0px 20px'>
                  <B>(k)</B> personal opinions made known to us (e.g. feedback
                ...
                <P margin='20px 0px 20px 0px'>
                  ...
                  third-party databases or service providers that provide
                ...
                <P
                  ...
                  size='1.2em'
                >
                  1.2 Purposes for collection, use and disclosure of your
                  personal data
                </P>
                <P margin='-10px 0px 0px 0px'>
                  Push may collect, use and/or disclose your personal data for
                  its business purposes, including operations for these
                  purposes. These may include, without limitation, the
                  following:
                </P>
                ...
                <ListGroup>
                  ...
                  <P margin='20px 0px 0px 40px'>
                    <B>(viii)</B> sending and receiving notifications and
                    Content from various channels on the Push Protocol;
                  </P>
                  ...
                  <P margin='20px 0px 0px 40px'>
                    <B>(x)</B> various products and/or services related to
                    digital assets;
                  </P>
                  ...
                  <P margin='20px 0px 0px 40px'>
                    <B>(xiii)</B> carrying out research, planning and
                  ...
                  <P margin='20px 0px 0px 20px'>
                    <B>(d)</B> managing our infrastructure and business
                  ...
                  <P margin='20px 0px 0px 20px'>
                    <B>(f)</B> addressing or investigating any complaints,
                    claims or disputes;
                  </P>
                  ...
                  <P margin='20px 0px 0px 20px'>
                    ...
                    require comparison of your personal information against
                    third party databases and/or provision of such information
                  ...
                  <P margin='20px 0px 0px 20px'>
                    <B>(l)</B> complying with obligations and requirements
                    imposed by us from time to time by any credit bureau or
                    credit information sharing services of which we are a member
                    or subscriber;
                  </P>
                  ...
                  <P margin='20px 0px 0px 20px'>
                    <B>(q)</B> seeking professional advice, including legal or
                    tax advice.
                  </P>

                  <P margin='20px 0px 20px 0px'>
                    We may also use personal data for purposes set out in the
                    Terms of Service that govern our relationship with you or
                    our customer.
                  </P>
                </ListGroup>
                ...
                <P margin='-10px 0px 0px'>
                  ...
                  limitation banks, financial institutions, credit card
                  companies, credit bureaus and their respective service
                  providers, companies providing services relating to insurance
                  and/or reinsurance to us, and associations of insurance
                  companies, agents, contractors or third party service
                  providers who provide services to us such as
                  ...
                  order to carry out the purposes set out above. Please be
                  assured that when we disclose your personal data to such
                  parties, we require them to ensure that any personal data
                ...
                <P margin='20px 0px 0px 0px'>
                  ...
                  refer to the agreement(s) and/or Terms of Service that govern
                  our relationship with you or our customer. You may also
                  contact us for more information (please see section 1.9
                  below).
                </P>
                ...
                <P margin='20px 0px 0px 0px'>
                  ...
                  applicable agreement(s) and/or Terms of Service that govern
                  our relationship with you or our customer or any applicable
                  law.
                </P>
                ...
                <P margin='20px 0px 0px 0px'>
                  ...
                  (please see section 1.9 below for contact details). Where you
                ...
                <P margin='-10px 0px 0px'>
                  ...
                  information, computer or device type, operating system,
                  internet service provider, website usage, referring/exit
                  pages, platform type, date/time stamp, number of clicks, and
                  ads viewed. We use cookies and other technologies to
                  facilitate your internet sessions and use of our apps, offer
                  you products and/or services according to your preferred
                  settings, track use of our websites and apps and to compile
                  statistics about activities carried out on our websites.
                </P>

                <P margin='20px 0px 20px 0px'>
                  You may set up your web browser to block cookies from
                  monitoring your website visit. You may also remove cookies
                ...
                <P margin='-10px 0px 20px'>
                  ...
                  maintained by Push. This Policy only applies to the websites
                  of Push. When visiting these third party websites, you should
                  read their privacy policies which will apply to your use of
                  such websites.
                </P>
                ...
                <P margin='-10px 0px 20px'>
                  ...
                  necessary for any legal or business purposes.
                </P>
                ...
                <P margin='20px 0px 0px 20px'>
                  ...
                  to your personal data in our possession or under our control;
                  or
                </P>
                ...
                <P margin='20px 0px 0px'>
                  ...
                  place. Such withdrawal may also result in the termination of
                  any agreement you may have with us. Our legal rights and
                ...
                <P margin='-10px 0px 20px'>
                  ...
                  available the updated Policy on the Website. You are
                  encouraged to visit the Website from time to time to ensure
                  that you are well informed of our latest policies in relation
                  to personal data protection. All communications, transactions
                  and dealings with us shall be subject to the latest version of
                  this Policy in force at the time.
                </P>
                ...
                <P margin='-10px 0px 20px'>
                  ...
                  European Union or European Economic Area. Subject to
                ...
                <P margin='20px 0px 20px'>
                  ...
                  do not use the Website or any services provided by Push. Your
                  continued use of the Website following the posting of changes
                  to this Policy will be deemed your acceptance of those
                  changes.
                </P>
              </ItemH>
            </ItemH>
