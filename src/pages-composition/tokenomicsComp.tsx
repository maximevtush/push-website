...
import { KBTokenomicsList } from '@site/src/config/KBTokenomicsList';
...
const TokenomicsComp = () => {
  ...
  const breadcrumbs = [
    {
      text: t(
        'pages.knowledge.tokenomics.explainer-section.breadcrumbs.knowledge-base'
      ),
      link: '/knowledge',
    },
  ];
  ...
  return (
    <Section>
      <Content className='skeletonsmall'>
        <ContentBlocks item={KBTokenomicsList} breadcrumbs={breadcrumbs} />
      </Content>
    </Section>
  );
};
