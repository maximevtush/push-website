              ...
              <HeroItem maxWidth='50%' alignItems='flex-start'>
                ...
                <HeroCTA gap='18px'>
                  <A
                    ...
                    title={t('pages.home.hero.alt-start-button')}
                    ...
                    zIndex='2'
                  >
                    {t('pages.home.hero.start-button')}
                  </A>
                </HeroCTA>
              </HeroItem>
            </HeroPrimary>
            ...
            <ItemV maxWidth={'849px'} margin='0px auto'>
              ...
              >
                <B color='var(--ifm-color-white)'>
                  {t('pages.home.notification-section.header.main-text')}
                </B>{' '}
                {t('pages.home.notification-section.header.other-text')}
              </H2>
            </ItemV>
          ...
          <Content alignSelf='center'>
            <ItemV maxWidth={'849px'} margin='0px auto' flexDirection='row'>
              <H2
                ...
                fontFamily='DM Sans, san-serif'
              >
                <B color='var(--ifm-color-white)'>{t('pages.home.chat-section.header.main-text')} </B>
                {t('pages.home.chat-section.header.other-text')}
                ...
                {ChatUseCasesList.map((item) => {
                  return (
                    <SplideSlide>
                      <NotificationMarquee>
                        <GridItem>
                          <H2 fontFamily='DM Sans, san-serif'>{item.title}</H2>
                          <StarIcon />
                        </GridItem>
                      </NotificationMarquee>
                    </SplideSlide>
        ...
        <TokenomicsSection id='tokenomics'>
          <Content alignSelf='center'>
            ...
            >
              ...
              >
                <ItemV alignItems='flex-start' justifyContent={'flex-start'}>
                  ...
                  <H2
                    ...
                    letterSpacing='normal'
                  >
                    {t('pages.home.network-section.title')}
                  </H2>
                </ItemV>
              ...
              <ItemV>
                <TokenItem>{t('pages.home.network-section.first-text')}</TokenItem>
                <TokenItem>{t('pages.home.network-section.second-text')}</TokenItem>
                <TokenItem>
                  {t('pages.home.network-section.third-text')}
                  <TagItem style={{ marginLeft: '10px' }}>NEW</TagItem>
                </TokenItem>
                <TokenItem>{t('pages.home.network-section.fourth-text')}</TokenItem>
                <TokenItem>{t('pages.home.network-section.fifth-text')}</TokenItem>
              </ItemV>
            </ItemH>
            <SlideLink
              ...
              <ItemV alignItems='flex-start' justifyContent='flex-start'>
                <AccordionGrid>
                  <Accordion
                    items={General}
                    fontFamily='DM Sans, san-serif'
                    textColor='var(--ifm-color-neutral-300) !important'
                  />
                </AccordionGrid>
            ...
            <ImageBackgroundDiv>
              ...
              >
                ...
                <H3
                  ...
                  margin={isTablet && '0 auto'}
                >
                  {t('pages.home.bg-section.subtitle')}
                </H3>
                ...
                <FaqLink
                  ...
                  fontFamily='DM Sans, san-serif'
                >
                  <p>{t('pages.home.bg-section.buttonText')}</p>
                </FaqLink>
              </ItemV>
            </ImageBackgroundDiv>
          </Content>
