...
const ConfettiSVG = styled.svg`
  ...
  .conf8 { fill: none; stroke: #f9b732; stroke-width: 3; stroke-linecap: round; stroke-miterlimit: 10; }
  ...
  return (
    <ConfettiContainer size={size} className={className} $flip={flip}>
      <ConfettiSVG viewBox="50 50 300 400" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Yellow strips */}
        <path id="yellow-strip" d="M179.7,102.4c0,0,6.6,15.3-2.3,25c-8.9,9.7-24.5,9.7-29.7,15.6c-5.2,5.9-0.7,18.6,3.7,28.2c4.5,9.7,2.2,23-10.4,28.2"/>
