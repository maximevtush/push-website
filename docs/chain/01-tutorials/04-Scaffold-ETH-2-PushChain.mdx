---
id: docs-chain-tutorials-scaffoldeth2-push-governance
title: "Configure Scaffold ETH 2 for Push Chain: Deploy and Interact with a Contract"
hide_title: false
slug: ./tutorial-scaffoldeth2-pushchain-governance
...
- Add proposal listing and live vote counts in the UI
- Persist proposals off‑chain (The Graph, a DB, or a simple JSON file) for faster indexing
- Add role‑based minting or token‑gated voting
- Explore universal transactions and cross‑chain UX with Push tooling
