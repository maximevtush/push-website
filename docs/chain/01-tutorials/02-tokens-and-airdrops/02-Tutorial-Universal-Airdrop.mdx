...
> **Note:** If you need `$PC` tokens to deploy the contract, you can get them from the [Push Chain Faucet](https://faucet.push.org/).
...
<NodeJSVirtualIDE repo={{title: "Open in Github", url: "https://github.com/pushchain/push-chain-examples/blob/main/tutorials/universal-airdrop/scripts/merkle-proof-generator.ts"}}>
